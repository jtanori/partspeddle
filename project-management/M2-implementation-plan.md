...
| Order | Ticket | Title | Parallelizable |
|-------|--------|-------|---------------|
| 1 | T2.1 | Identity Database Schema | No — foundation |
| 2 | T2.2 | User Aggregate & Profile Lifecycle | After T2.1 |
| 3 | T2.3 | SellerProfile & Onboarding State Machine | After T2.2 |
| 4 | T2.4 | Identity Repositories | After T2.1+T2.2+T2.3 |
| 5a | T2.5 | Identity API Routes | After T2.4 |
| 5b | T2.6 | Supabase Auth Webhook Handler | After T2.1+T2.4 |
| 5c | T2.7 | Identity Queue Workers | After T2.4 |
| 6 | T2.8 | Identity Integration Tests | After all above |
...
**Dependencies:** T2.1, T2.2, T2.3, T1.3 (outbox)
...
**Dependencies:** T2.1, T2.2, T2.3, T2.4, T2.5, T2.6, T2.7
